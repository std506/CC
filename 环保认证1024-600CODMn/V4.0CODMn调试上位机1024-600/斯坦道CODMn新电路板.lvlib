...
<Library LVVersion="16008000">
	...
	<Property Name="Alarm Database Name" Type="Str">D__Program_Files__x86__National_Instruments_LabVIEW_2016_data</Property>
	<Property Name="Alarm Database Path" Type="Str">D:\Program Files (x86)\National Instruments\LabVIEW 2016\data</Property>
	<Property Name="Data Lifespan" Type="UInt">3650</Property>
	<Property Name="Database Computer" Type="Str">localhost</Property>
	<Property Name="Database Name" Type="Str">D__Program_Files__x86__National_Instruments_LabVIEW_2016_data</Property>
	<Property Name="Database Path" Type="Str">D:\Program Files (x86)\National Instruments\LabVIEW 2016\data</Property>
	...
	<Property Name="NI.Lib.Version" Type="Str">4.5.0.0</Property>
	...
	<Item Name="Subvi" Type="Folder">
		...
		<Item Name="DataToHex" Type="Folder">
			...
			<Item Name="FloatToCDAB.vi" Type="VI" URL="../DataToHex/FloatToCDAB.vi"/>
		...
		<Item Name="COMn单步调试对话框.vi" Type="VI" URL="../Subvi/COMn单步调试对话框.vi"/>
		...
		<Item Name="CODMn插入数据.vi" Type="VI" URL="../Subvi/CODMn插入数据.vi"/>
		<Item Name="CODMn启动参数对话框.vi" Type="VI" URL="../main/UI/CODMn启动参数对话框.vi"/>
		<Item Name="CODMn启动命令.vi" Type="VI" URL="../main/CODMn启动命令.vi"/>
		...
		<Item Name="CODMn线性公式.vi" Type="VI" URL="../Subvi/CODMn线性公式.vi"/>
	...
	<Item Name="UI" Type="Folder">
		<Property Name="NI.SortType" Type="Int">3</Property>
		<Item Name="运维调试_CODMn.vi" Type="VI" URL="../main/UI/运维调试_CODMn.vi"/>
	...
	<Item Name="数据" Type="Folder">
		<Item Name="CODMn报警信息.vi" Type="VI" URL="../main/CODMn报警信息.vi"/>
	...
	<Item Name="通讯" Type="Folder">
		<Item Name="Modbus Write File Record" Type="Folder">
			...
			<Item Name="读取内置参数.vi" Type="VI" URL="../main/COM/Modbus Write File Record/读取内置参数.vi"/>
			<Item Name="写入内置参数.vi" Type="VI" URL="../main/COM/Modbus Write File Record/写入内置参数.vi"/>
			<Item Name="读取缺试剂参数.vi" Type="VI" URL="../main/COM/Modbus Write File Record/读取缺试剂参数.vi"/>
			<Item Name="写入缺试剂参数.vi" Type="VI" URL="../main/COM/Modbus Write File Record/写入缺试剂参数.vi"/>
		</Item>
		<Item Name="参数读取写入" Type="Folder">
			<Item Name="序列号写入.vi" Type="VI" URL="../main/COM/序列号写入.vi"/>
			...
			<Item Name="写入系列号对话框.vi" Type="VI" URL="../main/COM/写入系列号对话框.vi"/>
		</Item>
		<Item Name="CODMn通讯.vi" Type="VI" URL="../main/CODMn通讯.vi"/>
	...
	<Item Name="参数设置" Type="Folder">
		...
		<Item Name="量程参数设置.vi" Type="VI" URL="../main/参数设置/量程参数设置.vi"/>
		...
		<Item Name="曲线模型计算.vi" Type="VI" URL="../参数设置/曲线模型计算.vi"/>
